 ...
 * 
 */
public class InteractorStyleRhod3D extends AInteractorStyleTrackballCamera {

    private final EventsHandlerRhod3D events;

    // ########## Keyboard interaction ##########
    private final KeyboardEventRhod3D keyboardEvent;
     ...
     */
    public InteractorStyleRhod3D(Canvas canvas, vtkRenderer renderer, vtkRenderWindowInteractor renWinInteractor,
            IMraLogGroup source) {
        super(canvas, renderer, renWinInteractor);

        this.events = new EventsHandlerRhod3D(this, source);
        this.keyboardEvent = new KeyboardEventRhod3D(canvas, this, events);
