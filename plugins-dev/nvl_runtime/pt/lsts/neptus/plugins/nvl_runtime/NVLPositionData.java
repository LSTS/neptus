 ...
 *
 */
public class NVLPositionData implements Position {
    
    private final LocationType location;

    public NVLPositionData(LocationType l) {
        location = l;
    }
    ...
    public boolean near(Position areaCenter, double areaRadius) {        
        return location.getDistanceInMeters(((NVLPositionData)areaCenter).location) <= areaRadius;
    }
