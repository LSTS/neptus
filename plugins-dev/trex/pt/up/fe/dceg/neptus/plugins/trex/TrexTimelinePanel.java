 ...
 * 
 */
@PluginDescription(name = "TREX Timeline", icon = "pt/up/fe/dceg/neptus/plugins/trex/trex.png")
@Popup(accelerator = KeyEvent.VK_F6, pos = POSITION.BOTTOM, height = 300, width = 800, icon = "pt/up/fe/dceg/neptus/plugins/trex/trex.png")
