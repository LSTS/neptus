...
import pt.up.fe.dceg.neptus.plugins.containers.propeditor.ProfilesPropertyEditor;
import pt.up.fe.dceg.neptus.plugins.containers.propeditor.VerticalGroupPropertyEditor;
...
// documentation = "",
icon = "pt/up/fe/dceg/neptus/plugins/containers/layout.png")
public class GroupLayoutContainer extends ContainerSubPanel implements ConfigurationListener, LayoutProfileProvider {
     ...
     * (non-Javadoc)
     * 
     * @see pt.up.fe.dceg.neptus.consolebase.ContainerSubPanel#addSubPanel(pt.up.fe.dceg.neptus.consolebase.SubPanel)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see pt.up.fe.dceg.neptus.consolebase.ContainerSubPanel#removeSubPanel(pt.up.fe.dceg.neptus.consolebase.SubPanel)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see pt.up.fe.dceg.neptus.consolebase.ContainerSubPanel#setEditMode(boolean)
     */
    @Override
