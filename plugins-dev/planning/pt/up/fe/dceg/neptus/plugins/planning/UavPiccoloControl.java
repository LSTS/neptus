 ...
 * Created by pdias
 * 20/02/2011
 * $Id:: UavPiccoloControl.java 10012 2013-02-21 14:23:45Z pdias                $:
 */
...
public class UavPiccoloControl extends SimpleSubPanel implements MainVehicleChangeListener,
    ...
    private static final Icon ICON_PICCOLO_WP_DOWNLOAD = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/piccolo-wps.png", 24, 24);
    private static final Icon ICON_PICCOLO_WP_GOTO = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/piccolo-goto.png", 24, 24);
    private static final Icon ICON_PICCOLO_WP_GOTO_HO = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/piccolo-goto-ho.png", 24, 24);
    private static final Icon ICON_PICCOLO_WP_SHOW = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/piccolo-wp-show.png", 24, 24);
//    private static final Icon ICON_PICCOLO_WP_HIDE = ImageUtils.getScaledIcon(
//            "pt/up/fe/dceg/neptus/plugins/planning/piccolo-wp-hide.png", 24, 24);
    private static final Icon ICON_PICCOLO_WP_SHOW_FILTER = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/piccolo-wp-filter.png", 24, 24);
    private static final Icon ICON_PICCOLO_WP_SHOW_CONFIG = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/piccolo-wp-filter-config.png", 24, 24);
    private static final Icon ICON_CONFIG_DOWNLOAD = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/config-download.png", 24, 24);
//    private static final Icon ICON_CONFIG_UPLOAD = ImageUtils.getScaledIcon(
//            "pt/up/fe/dceg/neptus/plugins/planning/config-upload.png", 24, 24);
    private static final Icon ICON_EDIT = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/planning/edit2.png", 24, 24);
...
//                                            "No handover waypoint for " + vid + " to go to!");
     ...
     * 
     * @see
     * pt.up.fe.dceg.neptus.consolebase.SubPanelChangeListener#subPanelChanged
     * (pt.up.fe.dceg.neptus.consolebase.SubPanelChangeEvent)
     */
    @Override
     ...
     * 
     * @see
     * pt.up.fe.dceg.neptus.plugins.SimpleSubPanel#mainVehicleChange(java.lang
     * .String)
     */
    @Override
     ...
     * 
     * @see
     * pt.up.fe.dceg.neptus.plugins.ConfigurationListener#propertiesChanged()
     */
    @Override
...
//            gotoWaypointAction.setEnabled(false);
     ...
     * 
     * @see
     * pt.up.fe.dceg.neptus.renderer2d.Renderer2DPainter#paint(java.awt.Graphics2D
