 ...
 * Created by pdias
 * 21 de Jul de 2010
 * $Id:: EmergencyControlPanel.java 10012 2013-02-21 14:23:45Z pdias            $:
 */
...
public class EmergencyControlPanel extends SimpleSubPanel implements ConfigurationListener, MainVehicleChangeListener,
    ...
    private final ImageIcon ICON_ENABLE = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/planning/enable.png");
    private final ImageIcon ICON_DISABLE = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/planning/disable.png");
    private final ImageIcon ICON_QUERY = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/planning/sendquery.png");
