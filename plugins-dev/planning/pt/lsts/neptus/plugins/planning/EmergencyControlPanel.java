...
public class EmergencyControlPanel extends SimpleSubPanel implements ConfigurationListener, MainVehicleChangeListener,
    ...
    private final ImageIcon ICON_ENABLE = ImageUtils.getIcon("pt/lsts/neptus/plugins/planning/enable.png");
    private final ImageIcon ICON_DISABLE = ImageUtils.getIcon("pt/lsts/neptus/plugins/planning/disable.png");
    private final ImageIcon ICON_QUERY = ImageUtils.getIcon("pt/lsts/neptus/plugins/planning/sendquery.png");
