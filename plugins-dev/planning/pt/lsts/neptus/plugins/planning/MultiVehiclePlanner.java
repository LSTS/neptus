...
import pt.lsts.neptus.plugins.planning.MultiVehicleTask.TASK_STATE;
import pt.lsts.neptus.plugins.planning.MultiVehicleTask.TASK_TYPE;
 ...
 *
 */
@PluginDescription(name="MultiVehicle Planner", icon="pt/lsts/neptus/plugins/planning/stars.png")
...
public class MultiVehiclePlanner extends SimpleSubPanel implements StateRendererInteraction, Renderer2DPainter {
    ...
    protected Image stars = ImageUtils.getImage("pt/lsts/neptus/plugins/planning/stars.png");
