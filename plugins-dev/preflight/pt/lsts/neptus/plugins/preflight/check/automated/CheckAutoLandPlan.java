 ...
 *
 */
public class CheckAutoLandPlan extends AutomatedCheck  {
    private static final String PLAN_NAME = "auto_landing";
    
    public CheckAutoLandPlan(boolean maintainState) {
        super("Auto-landing", "Planning", maintainState, true);
    }
