...
public class FollowReferenceInteraction extends SimpleRendererInteraction implements IPeriodicUpdates {
    ...
    @NeptusProperty(description="Not Yet Implemented")
    ...
    /* (non-Javadoc)
     * @see pt.up.fe.dceg.neptus.plugins.SimpleRendererInteraction#paint(java.awt.Graphics2D, pt.up.fe.dceg.neptus.renderer2d.StateRenderer2D)
     */
    @Override
