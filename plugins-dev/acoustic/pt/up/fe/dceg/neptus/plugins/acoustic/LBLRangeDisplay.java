 ...
 * Created by pdias
 * 2009/09/27
 * $Id:: LBLRangeDisplay.java 10012 2013-02-21 14:23:45Z pdias            $:
 */
...
@PluginDescription(author = "Paulo Dias", name = "LBL Ranges", icon = "pt/up/fe/dceg/neptus/plugins/acoustic/lbl.png", description = "Displays the LblRanges and LblRangeRejections.", documentation = "lbl-ranges/lbl-ranges.html", category = CATEGORY.INTERFACE)
...
SubPanelChangeListener, MissionChangeListener, MapChangeListener, ConfigurationListener, NeptusMessageListener {
    ...
    private static final Icon ICON_LBL_SHOW = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/acoustic/lbl-show.png");
    private static final Icon ICON_LBL_HIDE = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/acoustic/lbl-hide.png");
    private static final Icon ICON_RESET = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/acoustic/reload.png");
    private static final Icon ICON_SOUND_ON = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/acoustic/sound.png");
    private static final Icon ICON_SOUND_OFF = ImageUtils
            .getIcon("pt/up/fe/dceg/neptus/plugins/acoustic/sound-off.png");
    private static final Icon ICON_SETTINGS = ImageUtils.getScaledIcon(
            ImageUtils.getImage("pt/up/fe/dceg/neptus/plugins/acoustic/settings.png"), 24, 24);
...
//        Point2D centerPos = renderer.getScreenPosition(new LocationType(lastKnownPos));
     ...
     * 
     * @see
     * pt.up.fe.dceg.neptus.consolebase.MissionChangeListener#missionChange(pt.up.fe.dceg.neptus.types.mission.MissionType
     * )
     */
    @Override
     ...
     * 
     * @see
     * pt.up.fe.dceg.neptus.consolebase.MissionChangeListener#missionUpdated(pt.up.fe.dceg.neptus.types.mission.MissionType
     * )
     */
    @Override
