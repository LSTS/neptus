 ...
 * Created by pdias
 * 7 de Jul de 2011
 * $Id:: RemotePositionPublisherUpdater.java 9615 2012-12-30 23:08:28Z pdias    $:
 */
...
import pt.up.fe.dceg.neptus.util.conf.StringPatternValidator;
import pt.up.fe.dceg.neptus.ws.PublishHelper;
...
@PluginDescription(name = "Remote Position Publisher Updater", author = "Paulo Dias", version = "1.0", icon = "pt/up/fe/dceg/neptus/plugins/webupdate/webupdate-pub-on.png")
public class RemotePositionPublisherUpdater extends SimpleSubPanel implements IPeriodicUpdates, ConfigurationListener {
    ...
    private final ImageIcon ICON_ENABLE = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/webupdate/webupdate-pub-on.png", 32, 32);
    private final ImageIcon ICON_DISABLE = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/webupdate/webupdate-pub-off.png", 32, 32);
