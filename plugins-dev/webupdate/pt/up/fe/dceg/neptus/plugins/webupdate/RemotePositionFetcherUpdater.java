 ...
 * Created by pdias
 * 7 de Jul de 2011
 * $Id:: RemotePositionFetcherUpdater.java 9615 2012-12-30 23:08:28Z pdias      $:
 */
...
icon="pt/up/fe/dceg/neptus/plugins/webupdate/webupdate-fetch-on.png")
...
public class RemotePositionFetcherUpdater extends SimpleSubPanel implements IPeriodicUpdates,
    ...
    private final ImageIcon ICON_ENABLE = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/webupdate/webupdate-fetch-on.png", 32, 32);
    private final ImageIcon ICON_DISABLE = ImageUtils.getScaledIcon(
            "pt/up/fe/dceg/neptus/plugins/webupdate/webupdate-fetch-off.png", 32, 32);
