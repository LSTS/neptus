 ...
 * Created by pdias
 * 2009/09/19
 * $Id:: LoggingDownloader.java 10012 2013-02-21 14:23:45Z pdias          $:
 */
...
import pt.up.fe.dceg.neptus.util.logdownload.LogFileInfoList;
import pt.up.fe.dceg.neptus.util.logdownload.LogFolderInfo;
...
@PluginDescription(author = "Paulo Dias and José Pinto", name = "Log Download", description = "", version = "3.0.0", icon = "pt/up/fe/dceg/neptus/plugins/logs/log.png", documentation = "logs-downloader/logs-downloader.html#console")
public class LoggingDownloader extends SimpleSubPanel implements MainVehicleChangeListener, IPeriodicUpdates,
    ...
    private static final ImageIcon ICON = ImageUtils.getIcon("pt/up/fe/dceg/neptus/plugins/logs/log.png");
