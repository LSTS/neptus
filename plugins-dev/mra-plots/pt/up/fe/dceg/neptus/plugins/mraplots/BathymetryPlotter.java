...
@PluginDescription(author = "Paulo Dias", name = "Bathymetry 2D", version = "0.9", icon = "pt/up/fe/dceg/neptus/plugins/mraplots/2D_v2.png")
            ...
            switch (opt) {
                ...
                case 2: // height map
                    ColorMapUtils.generateInterpolatedColorMap(bounds, dps, 0, toSave.createGraphics(),
                            toSave.getWidth(), toSave.getHeight(), 255,
                            ColorMapFactory.createGrayScaleColorMap(), dd.minVal[0] * 0.995, dd.maxVal[0] * 1.005);
                    break;
        ...
        t = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    XYZUtils.drawPath((Graphics2D) image.getGraphics(), scaleX, scaleY, minX, minY, timestep,
                            source);
