 ...
 * The class {@link VehicleAwareness} generates this events.
 * @author tsmarques
 *
 */
public class MvPlanningEventAvailableVehicle {
    private String vehicleId;

    public MvPlanningEventAvailableVehicle(String availableVehicleId) {
