 ...
 *
 */
public abstract class APointCloudColorHandler {
     ...
     * Constructor
     */
    public APointCloudColorHandler() {
    ...
    /**
     * Generate Color handlers for X Y Z
     * @param polyData
     * @param bounds
     * @param isColorInverted
     */
    public void generatePointCloudXYZColorHandlers(vtkPolyData polyData, double[] bounds, boolean isColorInverted) {
        ...
        if (!isColorInverted) {
            ...
            invertLUTXYZTableColors(bounds);
        }
    ...
    /**
     * Invert default colors on vtk LUT
     * @param bounds
     */
    private void invertLUTXYZTableColors (double[] bounds) {
