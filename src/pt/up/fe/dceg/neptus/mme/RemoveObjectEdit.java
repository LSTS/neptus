 ...
 * Created by 
 * 20??/??/??
 * $Id:: RemoveObjectEdit.java 9616 2012-12-30 23:23:22Z pdias            $:
 */
...
public class RemoveObjectEdit extends AbstractUndoableEdit {
	...
	public RemoveObjectEdit(MissionMapEditor mme, AbstractElement element) {
		this.map = mme.getMap();
		this.mme = mme;
	...
	public String getPresentationName() {
		return "Remove the "+element.getType()+" '"+element.getId()+"'";
	}
}
