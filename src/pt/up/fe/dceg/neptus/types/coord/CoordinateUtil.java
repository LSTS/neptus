...
//        loc.setLocation(loc2);
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < locations.length; i++) {
            ...
            System.out.println("loc1.getOffsetFrom(loc2)\t\t[" + diff1[0] + ", " + diff1[1] + ", " + diff1[2] + "]");

            double[] neDiff = CoordinateUtil.latLonDiff(loc2.latitude, loc2.longitude, loc1.latitude, loc1.longitude);
            System.out.println("loc1.getOffsetFromWorker(loc2)\t\t[" + neDiff[0] + ", " + neDiff[1] + ", " + 0 + "]");
            ...
            System.out.println("latLonDepthToGeocentricXYZ:loc1 \t[[" + locC1[0] + ", " + locC1[1] + ", " + locC1[2] + "]]");
            ...
            System.out.println("latLonDepthToGeocentricXYZ:loc2 \t[[" + locC2[0] + ", " + locC2[1] + ", " + locC2[2] + "]]");
            double[] diff2 = { locC1[0] - locC2[0], locC1[1] - locC2[1], locC1[2] - locC2[2] };
            System.out.println("diff of latLonDepthToGeocentricXYZ \t[" + diff2[0] + ", \t" + diff2[1] + ", \t" + diff2[2] + "]");
            ...
            System.out.println("diff similar to dune \t\t\t[" + n + ", \t" + e + ", \t" + 0 + "]");

            double[] locC3 = CoordinateUtil.WGS84displacement(loc2, loc1);
            System.out.println("WGS84displacement(loc2, loc1) \t\t[" + locC3[0] + ", \t" + locC3[1] + ", \t" + locC3[2] + "]");
            double[] diffPx = MapTileUtil.getOffsetFrom(loc2.latitude, loc2.longitude, loc1.latitude, loc1.longitude);
            System.out.println("MapTileUtil.getOffsetFrom(loc2, loc1) \t[" + diffPx[0] + ", \t" + diffPx[1] + ", \t" + 0 + "]");
...
//        System.out.println(CoordinateUtil.strtolon(te));
        ...
        System.out.println("rotation of pi/2 of point (1,1,1). The result should be (-1,1,1)");
        double[] teste = CoordinateUtil.bodyFrameToInertialFrame(1, 1, 1, 0, 0, Math.PI / 2);
        System.out.println(teste[0] + " " + teste[1] + " " + teste[2]);

        System.out.println("rotation of -pi/2 of point (-1,1,1). The result should be initial (1,1,1)");
        teste = CoordinateUtil.inertialFrameToBodyFrame(-1, 1, 1, 0, 0, Math.PI / 2);
        System.out.println(teste[0] + " " + teste[1] + " " + teste[2]);

        System.out.println();
        System.out.println(">>> Test latLonDepthToGeocentricXYZ and geocentricXYZToLatLonDepth:");
        ...
        System.out.println("Lat: " + latLonDep[0] + ", Lon: " + latLonDep[1] + ", Dep: " + latLonDep[2]);
        System.out.println("X: " + rev[0] + ", Y: " + rev[1] + ", Z: " + rev[2]);
        System.out.println("Lat: " + latLonDep2[0] + ", Lon: " + latLonDep2[1] + ", Dep: " + latLonDep2[2]);
         ...
         * System.out.println("Offset lat: "+offLat+", Offset lon: "+offLong); lt2.setLatitude(newCoords[0]); lt2.setLongitude(newCoords[1]); offLong =
         * lt2.getOffsetFrom(lt1)[1]; offLat = lt2.getOffsetFrom(lt1)[0]; System.out.println("Offset lat: "+offLat+", Offset lon: "+offLong);
         * System.out.println("lat: "+newCoords[0]+", lon: "+newCoords[1]);
         */
