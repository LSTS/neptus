...
public class LogUtils {
    ...
    public static LinkedHashMap<String, String> generateStatistics(IMraLogGroup source) {
        ...
        stats.put(I18n.text("Maximum depth"), GuiUtils.getNeptusDecimalFormat(2).format(maxDepth) + " m");
        stats.put(I18n.text("Avg depth"), GuiUtils.getNeptusDecimalFormat(2).format(avgDepth) + " m");
        ...
        stats.put(I18n.text("Distance travelled"), GuiUtils.getNeptusDecimalFormat(2).format(distance) + " m");
