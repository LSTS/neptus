 ...
 * Created by pdias
 * 2010/05/19
 * $Id:: SystemsList.java 10012 2013-02-21 14:23:45Z pdias                      $:
 */
...
import pt.up.fe.dceg.neptus.gui.system.AttentionSymbol;
import pt.up.fe.dceg.neptus.gui.system.AuthoritySymbol;
import pt.up.fe.dceg.neptus.gui.system.ConnectionSymbol;
import pt.up.fe.dceg.neptus.gui.system.ConnectionSymbol.ConnectionStrengthEnum;
import pt.up.fe.dceg.neptus.gui.system.EmergencyTaskSymbol;
import pt.up.fe.dceg.neptus.gui.system.EmergencyTaskSymbol.EmergencyStatus;
import pt.up.fe.dceg.neptus.gui.system.FuelLevelSymbol;
import pt.up.fe.dceg.neptus.gui.system.LocationSymbol;
...
import pt.up.fe.dceg.neptus.gui.system.SystemDisplay;
import pt.up.fe.dceg.neptus.gui.system.SystemDisplayComparator;
import pt.up.fe.dceg.neptus.gui.system.SystemPainterHelper;
import pt.up.fe.dceg.neptus.gui.system.SystemPainterHelper.CircleTypeBySystemType;
import pt.up.fe.dceg.neptus.gui.system.SystemTypeSymbol;
import pt.up.fe.dceg.neptus.gui.system.TaskSymbol;
...
import pt.up.fe.dceg.neptus.renderer2d.SystemPainterProvider;
    ...
    private String getSection4Data(ImcSystem sys, boolean htmlFragmentOrSimpleText, boolean extendedOrReduced,
        ...
        if (loc != null && !loc.isLocationEqual(LocationType.ABSOLUTE_ZERO)) {
            ...
            txtInfo += I18n.text("Lat") +": "
                    + CoordinateUtil.latitudeAsPrettyString(MathMiscUtils.round(loc.getLatitudeAsDoubleValue(), 6),
                            false)
                    + " "
                    + I18n.text("Lon") +": "
                    + CoordinateUtil.longitudeAsPrettyString(MathMiscUtils.round(loc.getLongitudeAsDoubleValue(), 6),
                            false)
