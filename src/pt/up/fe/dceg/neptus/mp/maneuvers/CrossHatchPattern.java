 ...
 * Created by pdias
 * 15/09/2011
 * $Id:: CrossHatchPattern.java 9615 2012-12-30 23:08:28Z pdias                 $:
 */
...
public class CrossHatchPattern extends RowsPattern {

    {
        ...
        ignoreAlternationPercentage = true;
    }
...
//        ManeuversUtil.paintPointLineList(g2d, zoom, points, true, sRange, editing);
        g2d.rotate(Math.PI/2);
        g2d.rotate(renderer.getRotation());
    ...
    protected void recalcPoints() {
        Vector<double[]> newPoints = ManeuversUtil.calcCrossHatchPatternPoints(width, hstep,
                curvOff, squareCurve, bearingRad);
        points = newPoints;
    }
