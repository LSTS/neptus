...
public class HTMLExporter {
    ...
    public static Html createHTML(ArrayList<LogMarkerItem> toExportList) {
        ...
        final String[] classifColorStyle = new String[7];
        classifColorStyle[0] = new String("color: BlueViolet;"); //UNDEFINED
        classifColorStyle[1] = new String("color: Brown;"); //NONE
        classifColorStyle[2] = new String("color: Chocolate;"); //CABLE
        classifColorStyle[3] = new String("color: Crimson;"); //PIPE
        classifColorStyle[4] = new String("color: DarkSalmon;"); //ROCK
        classifColorStyle[5] = new String("color: DarkSeaGreen;"); //WRECK
        classifColorStyle[6] = new String("color: MediumOrchid;"); //UNKNOWN
                        ...
                        new TBody(this) {{
                            new Tr(this, customAttribute7) {{
                                ...
                                new Td(this, style11) {{
                                    ...
                                    new P(this) {{
                                        new NoTag(this, Double.toString(depth));
                                    }};
                                }};
                            }};
                            new Tr(this) {{
                                new Td(this, colSpan12, align5) {{
                                    ...
                                    new H2(this) {{
                                        new Span(this, new Style(classifColorStyle[0])) {{
                                            new Strong(this) {{
