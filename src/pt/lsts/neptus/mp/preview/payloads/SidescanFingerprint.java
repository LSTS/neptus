 ...
 *
 */
public class SidescanFingerprint extends PayloadFingerprint {

    protected double range;
    
    public SidescanFingerprint(double range) {
        super("Sidescan", new Color(192, 192, 0, 128));
        this.range = range;
    }
    ...
    public Area getFingerprint(SystemPositionAndAttitude pose) {
        ...
        Rectangle2D r2 = new Rectangle2D.Double(-sssRange, -1, sssRange, 1.3);
