...
public class JsfSidescanParserChecker implements SidescanParserChecker<JsfSidescanParser> {
    ...
    public List<File> listDataFiles(IMraLogGroup log) {
        File file = log.getFile(JSF_FILE);
        if (file != null)
    ...
    @Override
    public JsfSidescanParser getParser(IMraLogGroup log) {
