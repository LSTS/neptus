...
public class Imagenex872SidescanParserChecker implements SidescanParserChecker<Imagenex872SidescanParser> {
    ...
    public List<File> listDataFiles(IMraLogGroup log) {
        File file = log.getFile(I872_FILE);
        if (file != null)
    ...
    @Override
    public Imagenex872SidescanParser getParser(IMraLogGroup log) {
