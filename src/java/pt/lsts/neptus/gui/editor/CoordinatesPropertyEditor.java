 ...
 * @author ZP
 */
public class CoordinatesPropertyEditor extends AbstractPropertyEditor {

	protected JTextField textField = new JTextField();
	private JButton button = new FixedButton();
	LocationType locationType = new LocationType();
	public CoordinatesPropertyEditor() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				LocationType newLoc = LocationPanel.showCoordinatesDialog("Edit Coordinates", null, locationType);
				if (newLoc != null) {
					setValue(newLoc);
