 ...
 * except in compliance with the Licence. Unless required by applicable law or
 * agreed to in writing, software distributed under the Licence is
...
import pt.lsts.neptus.mp.maneuvers.Sampling;
import pt.lsts.neptus.types.coord.LocationType;

/**
 * Preview for Sampling maneuver.
 * @author jcordeiro
 */
public class SamplingPreview implements IManeuverPreview<Sampling> {
    ...
    @Override
    public boolean init(String vehicleId, Sampling man, SystemPositionAndAttitude state, Object manState) {
