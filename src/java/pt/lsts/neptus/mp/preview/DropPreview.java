 ...
 *
 */
public class DropPreview implements IManeuverPreview<Drop> {
    ...
    @Override
    public boolean init(String vehicleId, Drop man, SystemPositionAndAttitude state, Object manState) {
