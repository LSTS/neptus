 ...
 * @author ZP
 */
public class ManeuverLocationEditor extends AbstractPropertyEditor {
    ...
    public ManeuverLocationEditor() {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                oldLoc.setLocation(location);

                LocationType newLoc = SimpleLocationPanel.showHorizontalLocationDialog(oldLoc,
                        I18n.text("Change maneuver location"), true, editor);
                if (newLoc != null) {
                    setValue(newLoc);
    ...
    public void setValue(Object arg0) {
        ...
        Z_UNITS oldUnits = location.getZUnits();
        
        if (arg0 instanceof ManeuverLocation) {
            location.setLocation((ManeuverLocation) arg0);
            location.setZ(oldz);
            location.setZUnits(oldUnits);
            textField.setText(location.toString());
        }
    }
