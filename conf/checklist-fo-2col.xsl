	...
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="default-page" page-height="297mm" page-width="210mm" margin-left="0.6in" margin-right="0.6in" margin-top="0.1in" margin-bottom="0.6in" >
				<fo:region-body margin-top="0.79in" margin-bottom="0.79in" column-count="2" column-gap="0.3in"/>
		...
		<fo:root>
			...
			<fo:page-sequence master-reference="default-page" initial-page-number="1" format="1">
				...
				<fo:flow flow-name="xsl-region-body">
					<fo:block>
						<fo:block span="all" space-before.optimum="1pt" space-after.optimum="2pt">
							<!--fo:block><fo:external-graphic src="url(images/neptus_logo_n.svg)" scaling="uniform" content-width="50pt" content-height="50pt" vertical-align="middle"/></fo:block-->
							<fo:block color="gray">
								<xsl:for-each select="checklist">
									<xsl:for-each select="@name">
