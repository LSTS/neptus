...
start %JAVA_BIN_FOLDER%javaw.exe -Xms10m -Xmx912m -Dj3d.rend=d3d -Dsun.java2d.d3d=true -Djava.library.path="%LIBRARYPATH%" -cp %CLASSPATH% pt.up.fe.dceg.neptus.mc.lauvconsole.LAUVConsole %1 %2 %3 %4 %5 %6 %7 %8 %9
set PATH=%OLDPATH%
